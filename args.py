...
PRESAVE_DIR = ""
MODEL_DIR = os.path.join(os.environ["CVL_DATA_DIR"], "frozen_bilm/checkpoints")
DATA_DIR = os.path.join(os.environ["CVL_DATA_DIR"], "frozen_bilm/data")
SSD_DIR = ""
name2folder = {
    "webvid": "WebVid",
    "lsmdc": "LSMDC",
...
def get_args_parser():
    ...
    parser.add_argument(
        ...
        default=1,
        type=int,
        help="the number of models to create. inference each sample with the corresponding model.",
    )
    parser.add_argument(
        "--router_results",
        default="",
        type=str,
        help="The directory to store the router's result for each dataset",
    )
    ...
    parser.add_argument(
        "--envqa_features_path",
        default=os.path.join(DATA_DIR, name2folder["envqa"], "clipvitl14.pth"),
    )
    parser.add_argument(
        "--envqa_train_csv_path",
        default=os.path.join(DATA_DIR, name2folder["envqa"], "train.csv"),
    )
    parser.add_argument(
        "--envqa_val_csv_path",
        default=os.path.join(DATA_DIR, name2folder["envqa"], "val.csv"),
    )
    parser.add_argument(
        "--envqa_test_csv_path",
        default=os.path.join(DATA_DIR, name2folder["envqa"], "test.csv"),
    )
    parser.add_argument(
        "--envqa_vocab_path",
        default=os.path.join(DATA_DIR, name2folder["envqa"], "vocab.json"),
    )
 
    # trafficqa
    parser.add_argument(
        "--trafficqa_features_path",
        default=os.path.join(DATA_DIR, name2folder["trafficqa"], "clipvitl14.pth"),
    )
    parser.add_argument(
        "--trafficqa_train_csv_path",
        default=os.path.join(DATA_DIR, name2folder["trafficqa"], "train.csv"),
    )
    parser.add_argument(
        "--trafficqa_test_csv_path",
        default=os.path.join(DATA_DIR, name2folder["trafficqa"], "test.csv"),
    )
    parser.add_argument(
        "--trafficqa_vocab_path",
        # default=os.path.join(DATA_DIR, name2folder["trafficqa"], "vocab.json"),
        default=os.path.join(DATA_DIR, "vocab_9db.json"),
    )
    ...
    parser.add_argument(
        ...
        default="",
        type=str,
        help="the vocab path shared by all the datasets",
    )
